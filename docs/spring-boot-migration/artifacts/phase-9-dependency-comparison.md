...
Sources: `phase-0-dependency-tree-before.txt` / `phase-0-dependency-list-before.txt` (Spring Boot 2.7.18, JDK 11) vs `phase-9-dependency-tree-after.txt` / `phase-9-dependency-list-after.txt` (Spring Boot 3.5.16, JDK 21).

## Key managed/explicit version deltas

| Artifact | Before | After |
|----------|--------|-------|
| org.springframework.boot:spring-boot | 2.7.18 | **3.5.16** |
| org.springframework:spring-core | 5.3.31 | **6.2.19** |
| org.springframework.security:spring-security-core | 5.7.11 | **6.5.11** |
| org.hibernate(.orm):hibernate-core | 5.6.15.Final | **6.6.26.Final** |
| org.apache.tomcat.embed:tomcat-embed-core | 9.0.83 | **10.1.55** (Jakarta Servlet 6) |
...
| org.springdoc:springdoc-openapi-**ui** | 1.6.15 | replaced by **springdoc-openapi-starter-webmvc-ui 2.8.17** |
