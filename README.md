# Banking Application using Java 18, Spring Boot, Spring Security and H2 DB
...
* Java 18 (LTS) - OpenJDK 11 or later
...
This application has been migrated from Java 8 to Java 18 (LTS). See `MIGRATION_NOTES.md` for detailed information about the migration process and changes made.
