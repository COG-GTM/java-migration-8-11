...
This application has been migrated from Java 8 to Java 11 and then to Java 21 (LTS) with Spring Boot 3.2. See `MIGRATION_NOTES.md` for detailed information about the migration process and changes made.
