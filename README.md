...
This application has been migrated from Java 8 to Java 21 (LTS). See `MIGRATION_NOTES.md` for detailed information about the migration process and changes made.
