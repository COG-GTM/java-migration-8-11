# Banking Application using Java 17, Spring Boot 3, Spring Security and H2 DB
...
This application has been migrated to Java 17 (LTS) and Spring Boot 3.x (`jakarta.*` namespace, Spring Security 6). See `MIGRATION_NOTES.md` for detailed information about the migration process and changes made.
