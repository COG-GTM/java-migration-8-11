...
This application has been migrated from Java 8 to Java 11, and subsequently upgraded to Java 17 (LTS) with Spring Boot 3.2.x. See `MIGRATION_NOTES.md` for detailed information about the migration process and changes made.
